...
- e_sr_mean_shift: S1 reachability has no run-backed evidence
- e_sr_mean_shift S2 e_sr_mean_shift/N2-m30: arl rule: [896.9515591005242, 1110.3524408994758] straddles 1/alpha_arl 1000; needs more N; suppressed verdict: INCONCLUSIVE
- e_sr_mean_shift S2 e_sr_mean_shift/N4-p09-m100: arl rule: [948.7580697930078, 1174.497930206992] straddles 1/alpha_arl 1000; needs more N; suppressed verdict: INCONCLUSIVE
- e_sr_mean_shift S3 e_sr_mean_shift: power cell at shift_sigma=0.75 x10: registered effect size, but not the inertness-floor shift (3) — not scored for INERT
- e_sr_mean_shift: S2 suppressed verdicts — INCONCLUSIVE x2
- e_sr_mean_shift_bounded: S1 reachability has no run-backed evidence
- e_sr_mean_shift_bounded S3 e_sr_mean_shift_bounded: power cell at shift_sigma=0.75 x13: registered effect size, but not the inertness-floor shift (3) — not scored for INERT
...
- family_A_betting_e_process: S2 excluded without token: family_A_betting_e_process x6 (non-finite increment estimator)
...
- family_C_safe_hotelling S2 family_C_safe_hotelling/N4-p09-m100: unmapped verdict token inconclusive
- family_C_safe_hotelling S2 family_C_safe_hotelling/N5: unmapped verdict token inconclusive
- family_C_safe_hotelling: S2 suppressed verdicts — inconclusive x3
...
- safe_t_e_value S3 safe_t: phi unmeasured on a power cell x3: scored anyway (power is not a validity claim); the per-null pairing gap is recorded separately
- safe_t_e_value: S2 suppressed verdicts — not-refuted x9
...
- universal_inference_e_value S3 universal_inference: phi unmeasured on a power cell x3: scored anyway (power is not a validity claim); the per-null pairing gap is recorded separately
