# Fault-class coverage — protocol v1, engine 68b9b2c
...
|---|---|---|---|---|
| K1 | YES | e_sr_mean_shift, safe_t_e_value, universal_inference_e_value | T1 | 1, 1, 0.9875 |
...
- K1: also COVERED by e_sr_mean_shift_bounded 1 (verdict REFUSE — see card)
