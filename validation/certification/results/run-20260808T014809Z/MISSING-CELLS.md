...
- safe_t_e_value S3 safe_t: power cell with no shift_sigma recorded x30: its effect size is unknown, so it cannot be placed at the inertness-floor shift (3) — not scored for INERT
