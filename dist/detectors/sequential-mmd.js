...
exports.BASELINE_POOL_SIZE = void 0;
exports.freshMMDState = freshMMDState;
exports.getOrCreateMMDState = getOrCreateMMDState;
exports.rbf = rbf;
exports.computeUt = computeUt;
exports.generateBaselinePool = generateBaselinePool;
exports.baselinePoolSeed = baselinePoolSeed;
...
exports.BASELINE_POOL_SIZE = 500;
...
function eMmdBettingStep(state, dT, eMmd, threshold) {
    ...
    if (dStd > 1)
        ...
        dStd = -1;
    const picked = (0, betting_e_process_1.pickBet)(state.runningMean, state.runningSecondMoment, state.bet);
...
function evaluateEMmd(cfg, liveMetrics, states, ctx) {
    ...
    if (suppressed)
        return suppressed;
    const v = liveVector(liveMetrics, params.mean_vector, cfg.family_c_signals ?? hotelling_1.FAMILY_C_SIGNALS);
    if (v === null)
        return null;
    ...
    if (!pool || pool.length === 0) {
        pool = generateBaselinePool(params, exports.BASELINE_POOL_SIZE, baselinePoolSeed({ hour_of_day: ctx.hourOfDay, day_of_week: ctx.dayOfWeek }));
        states[poolKey] = pool;
    }
...
//# sourceMappingURL=sequential-mmd.js.map