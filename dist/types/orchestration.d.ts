...
import type { FailFastState, SchemaContinuityRecord, ReversibilityClassification } from './policy';
...
export interface OrchestrateParams {
    ...
    ignoreThresholds?: Record<string, {
        min?: number;
        max?: number;
    }>;
     ...
     *  is set. */
    buildAgentInputContext?: (group: import('./verdict').VerdictGroup, reversibility: ReversibilityClassification) => import('./agent').AgentInputContextLike;
