...
export const DEFAULT_PROBATIONARY_FRACTION = 0.15;
...
export const DEFAULT_SPECTRAL_MIN_PEAK_LAG = 3;
export const DEFAULT_SPECTRAL_MAX_PEAK_LAG = 10;
...
export const SPECTRAL_BOOTSTRAP_WINDOW = 60;
...
export const SPECTRAL_BOOTSTRAP_QUANTILE = 0.99;
...
export const SPECTRAL_BOOTSTRAP_MIN_SUBWINDOWS = 30;
 ...
 *  on short datasets. */
export const SPECTRAL_BOOTSTRAP_FALLBACK_QUANTILE = 0.90;
...
export const DEFAULT_FAMILY_A_COOLDOWN_TICKS = 1000;
...
export const DEFAULT_SMOOTHING: Record<'pageCusum' | 'betting' | 'mixtureSupermartingale' | 'spectral', {
  window: number;
...
export const AR1_PHI_FALLBACK_THRESHOLD = 0.5;
...
export const AR1_PHI_HAC_CLAMP = 0.99;
...
export const TOOL_VERSION = 'NAB-per-dataset v0.1.0';
...
export function sampleVariance(xs: number[], mu: number): number {
...
export function ar1Phi(xs: number[], mu: number): number {
