...
// ADR 0033 (v0.8.0-pre): the optional DeploySignal orchestration hooks that used to sit on these
// types (lifecycle emitter/state, reversibility source and action, topology enricher) left with
// DeploySignal's runtime; DeploySignal declares them on its own copies of these types.
