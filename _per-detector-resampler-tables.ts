...
// engine/_per-detector-resampler-tables.ts — source-of-truth dispatch
// tables + per-detector field/budget enumerations for the Topic 58
// per-detector resampler-mode logic. Pure data; depends only on the
// shared type module.
