...
exports.fleetMergeFamilyA = fleetMergeFamilyA;
exports.fleetMergeFamilyC = fleetMergeFamilyC;
...
function fleetMergeStep(log_e_values, primitive, fleet_state, log_threshold) {
    const out = primitive(log_e_values);
    (0, combine_1.updateFleetEProcessState)(fleet_state, out.log_fleet_e, log_threshold);
...
function fleetMergeFamilyA(per_shard_states, primitive, fleet_state, log_threshold) {
    const log_e_values = [];
...
function fleetMergeFamilyC(per_shard_states, primitive, fleet_state, log_threshold) {
    const log_e_values = [];
    for (const state of per_shard_states) {
