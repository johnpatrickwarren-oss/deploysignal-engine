...
exports.E_SR_MEAN_SHIFT_ENVELOPE = exports.E_SR_DEFAULT_ALPHA_ARL = exports.E_SR_LAMBDA_GRID = void 0;
...
function freshESrMeanShiftState(params = {}) {
    const K = (params.lambdas ?? exports.E_SR_LAMBDA_GRID).length;
    return {
...
function evaluateESrMeanShift(r, params, state) {
    ...
    const lambdas = params.lambdas ?? exports.E_SR_LAMBDA_GRID;
