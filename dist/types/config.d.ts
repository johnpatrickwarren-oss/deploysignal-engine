...
export interface CompiledConfig {
    ...
    traffic_pct_gate?: {
        min_traffic_pct_for_fire: number;
    };
...
export type BaselineCurationDecisionId = 'D1' | 'D2' | 'D3' | 'D4' | 'D5' | 'D6' | 'D7' | 'D8' | 'D9' | 'D10' | 'D11' | 'D12' | 'D13';
...
export type RegressionDeltaKind = 'absolute' | 'relative_to_baseline_sigma' | 'relative_to_baseline_mean';
...
export type BaselineProvenance = 'synthetic' | 'real_burstgpt' | 'real_azure_llm_inference' | 'real_mooncake' | 'grounded_synthetic' | 'mixed' | 'real_huggingface_lmsys_arena';
...
export interface BaselineCellEntry {
    ...
    family_A?: {
        per_signal: Record<string, FamilyAPerSignalParams>;
    };
...
export type CellDimension = 'hour_of_day' | 'day_of_week' | 'workload_class' | 'tenant_slice' | 'tenant_tier' | 'region' | 'shard_id';
export type CellConfidence = 'strict' | 'pooled' | 'aggregate' | 'none' | 'warm_start';
