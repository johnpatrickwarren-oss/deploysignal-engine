...
(0, node_test_1.test)('envelopes: plug-in betting/mixture AND the corrected BF are invalid-under-estimated-baseline', () => {
    ...
    strict_1.default.equal(validity_envelope_1.NUISANCE_ROBUST_BF_ENVELOPE.validUnderEstimatedBaseline, false);
});
// ── The FDR-path gate. ────────────────────────────────────────────────────────────────────────────
(0, node_test_1.test)('gate: the corrected BF is NO LONGER auto-admissible to the FDR path (2026-07-02)', () => {
    strict_1.default.equal((0, validity_envelope_1.isValidForFdrPath)(validity_envelope_1.NUISANCE_ROBUST_BF_ENVELOPE), false);
    strict_1.default.equal((0, validity_envelope_1.isValidForFdrPath)(validity_envelope_1.NUISANCE_ROBUST_BF_ENVELOPE, {}), false);
    // Its inflation is bounded (≈1.155·q), so a caller may still admit it under an explicit regime
    // assertion — but never silently.
    strict_1.default.equal((0, validity_envelope_1.isValidForFdrPath)(validity_envelope_1.NUISANCE_ROBUST_BF_ENVELOPE, { trueBaseline: true }), true);
});
...
(0, node_test_1.test)('gate: assertValidForFdrPath throws for an unasserted plug-in e-value, passes otherwise', () => {
    ...
    strict_1.default.doesNotThrow(() => (0, validity_envelope_1.assertValidForFdrPath)(safe_t_e_value_1.SAFE_T_ENVELOPE, { phiUnmeasuredAccepted: true }));
    strict_1.default.throws(() => (0, validity_envelope_1.assertValidForFdrPath)(safe_t_e_value_1.SAFE_T_ENVELOPE, { observedPhi: 0.99 }), /φ=0.99/);
});
...
(0, node_test_1.test)('guarantee: FP/FDR is by-construction only when ALL conditions hold (valid e-value, minority faults, scalar, coupled)', () => {
    const base = {
        ...
        eValueEnvelope: safe_t_e_value_1.SAFE_T_ENVELOPE,
